...
namespace ConsoleApp.TestTasks
{
    internal class Test1
    {
        /*
         Задача на одном из собеседований:
            Тестовое задание.
        ...
        public static void Run()
        {
            ...
            //число разделим по среднему элементу, получим всего 6 знаков -  6^13 комбинаций
            //Со средним знаком числа (0-С) по обе стороны  6^13*13
            //
            // 1 - 13^1
            // 2 - 13^2   
